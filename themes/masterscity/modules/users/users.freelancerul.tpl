        ...
        <div>
            <div class="uk-panel uk-panel-box">
                <div class="tp-panel-body">
                    ...
                    <!-- ENDIF -->
                            <!-- IF {USERS_ROW_ISPRO} -->
                            <span class=" uk-text-danger uk-text-bold tp-text-transform">{PHP.L.Ak_pro}</span>
                            <!-- ENDIF -->
                        </div>
                        <div class="uk-width-3-4">
						<span class="uk-h6 tp-text-transform uk-margin-bottom-remove uk-margin-top-remove uk-link-primary">{USERS_ROW_CATS|cot_usercategories_tree($this, '', 'listlev1')}</span>
                            <p><h4 class="uk-text-truncate uk-margin-bottom-remove uk-margin-top-remove"><a class="tp-color-ts" href="{USERS_ROW_DETAILSLINK}">
								...
								{USERS_ROW_NICKNAME}
								<!-- ENDIF -->
								<!-- IF {USERS_ROW_NAMECOMPANY} -->
								<span class="uk-text-bold uk-text-danger uk-text-truncate">{USERS_ROW_NAMECOMPANY}</span>
								<!-- ENDIF -->
							</a>
							</h4>
