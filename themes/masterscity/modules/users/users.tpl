    ...
    <div class="uk-panel uk-panel-box uk-margin-bottom">
        ...
        <div class="uk-grid uk-margin-bottom" data-uk-grid-margin="">
            ...
            <div class="uk-width-medium-1-4 uk-margin-small-top">
                    <a class="tp-button uk-button-transparent tp-text-transform uk-button uk-width-1-1" href="{PHP.cot_groups.4.alias|cot_url('users', 'm=register&usergroup='$this)}">Я Частный исполнитель</a>
					<p><a class="tp-button uk-button tp-text-transform uk-width-1-1" href="{PHP.cot_groups.8.alias|cot_url('users', 'm=register&usergroup='$this)}">Компания или ФЛП</a></p>
                    <p><a class="tp-button uk-button tp-text-transform uk-width-1-1" href="{PHP.cot_groups.7.alias|cot_url('users', 'm=register&usergroup='$this)}">Я заказчик</a></p>
            </div>
            <!-- ENDIF -->
        </div>
    </div>
                ...
                <div class="tp-panel-body">
                    <div class="uk-grid">
                        <div class="uk-width-1-4">
                            ...
                            <img class="avatar uk-border-circle" width="100" height="100" alt="{USERS_ROW_NICKNAME}" src="{USERS_ROW_AVATAR_SRC}">
                            <!-- ELSE -->
                            <img class="avatar uk-border-circle" width="100" height="100" alt="{USERS_ROW_NICKNAME}" src="themes/{PHP.theme}/img/avatar.png">
                            <!-- ENDIF -->
                        </div>
                        <div class="uk-width-3-4">
                            <h5 class="uk-text-truncate uk-margin-bottom-remove"><a class="tp-color-ts" href="{USERS_ROW_DETAILSLINK}">{USERS_ROW_NICKNAME}</a></h5>
                                ...
                                <div class="uk-width-3-4">
                                    <div class="uk-grid">
                                        ...
                                        <div class="uk-width-medium-1-2 uk-text-right">
                                            <i class="uk-icon-thumbs-o-down uk-text-danger"></i> &nbsp;{USERS_ROW_REVIEWS_NEGATIVE_SUMM} &nbsp;&nbsp;
                                            <i class="uk-icon-thumbs-o-up uk-text-success"></i> &nbsp; {USERS_ROW_REVIEWS_POZITIVE_SUMM}
                                        </div>
                                        <!-- ENDIF -->
