...
<!-- ENDIF -->
        ...
        <div class="uk-modal-footer">
            <div class="uk-container-center uk-width-1-2">
                <button class="uk-hidden-small uk-margin-top tp-text-transform uk-button uk-button-primary uk-button-large uk-width-1-1" type="submit">{PHP.L.Register}</button>
