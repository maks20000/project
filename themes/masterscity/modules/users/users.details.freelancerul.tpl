    ...
    <div class="uk-grid" data-uk-grid-margin="">
        <div class="uk-width-medium-1-4">
            <div class="tp-box uk-panel">
                ...
                <!-- ENDIF -->
				<!-- IF {PHP.usr.auth.plug.loginAsUser} AND {USERS_DETAILS_ID} != {PHP.usr.id} AND {PHP.usr.maingrp} == 5 -->
                    <span class="">
                ...
                <div class="uk-panel-body">
                    ...
                    <ul class="uk-list uk-list-line uk-margin-remove">
						...
						<!-- IF {PHP.usr.id} == {USERS_DETAILS_ID} -->
						<!-- IF {PHP.cot_plugins_active.prjsender} -->
						<li>
						<a class="uk-width-medium-1-1 uk-button uk-button-success" href="{PHP|cot_url('prjsender')}">{PHP.L.prjsender}</a>
						</li>
						<!-- ENDIF -->
						<!-- ENDIF -->
						<!-- IF {PHP.usr.id} == {USERS_DETAILS_ID} -->
						...
						<li>
						<a class="uk-width-medium-1-1 uk-button uk-button-success" href="{PHP|cot_url('affiliate')}">{PHP.L.affiliate}</a>
						</li>
						<!-- ENDIF -->
						<!-- ENDIF -->
				...
				<!-- IF {PHP.cot_plugins_active.sbr} AND {PHP.usr.id} > 0 -->
                            ...
                            <div class="uk-overflow-container">
                                <table class="uk-table uk-table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											<!-- IF {USERS_DETAILS_ADRESS_FACT} -->
											<td><span class="uk-text-bold ti-linck-black">{USERS_DETAILS_ADRESS_FACT_TITLE}:</span></td>
											<td><span class="uk-text-bold uk-text-primary">{USERS_DETAILS_ADRESS_FACT}</span></td>
											<!-- ENDIF -->
                                        </tr>
                                        <tr>
											<!-- IF {USERS_DETAILS_NAMECOMPANY} -->
											<td><span class="uk-text-bold ti-linck-black">{USERS_DETAILS_NAMECOMPANY_TITLE}:</span></td>
											<td><span class="uk-text-bold uk-text-primary">{USERS_DETAILS_NAMECOMPANY}</span></td>
											<!-- ENDIF -->
                                        </tr>
									...
									<!-- ENDIF -->
                                        <tr>
											<!-- IF {USERS_DETAILS_NAMEPERSONOTVET} -->
											<td><span class="uk-text-bold ti-linck-black">{USERS_DETAILS_NAMEPERSONOTVET_TITLE}:</span></td>
											<td><span class="uk-text-bold uk-text-primary">{USERS_DETAILS_NAMEPERSONOTVET}</span></td>
											<!-- ENDIF -->
                                        </tr>
                                        <tr>
									...
									<!-- IF {USERS_DETAILS_TELEPHONE_OTVETZ_PERSON} -->
                                        <tr>										
											<td><span class="uk-text-bold ti-linck-black">{USERS_DETAILS_TELEPHONE_OTVETZ_PERSON_TITLE}</span></td>
											<td><span class="uk-text-bold uk-text-primary">
											<!-- IF {PHP.usr.id} > 0 -->
											{USERS_DETAILS_TELEPHONE_OTVETZ_PERSON}
											<!-- ENDIF -->
											<!-- IF {PHP.usr.id} == 0 -->
											Гостям не показывается
											<!-- ENDIF -->
