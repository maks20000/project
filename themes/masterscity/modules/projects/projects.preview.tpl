    ...
    <div class="tp-panel-border tp-panel-box" data-uk-alert="">
        <div class="uk-grid">
            ...
            <div class="uk-width-1-2">
                <a class="uk-width-1-1 uk-button uk-button-success" href="{PRJ_SAVE_URL}">{PHP.L.Publish}</a>
            </div>
            <div class="uk-width-1-2">
                <a class="uk-width-1-1 uk-button" href="{PRJ_EDIT_URL}">{PHP.L.Edit}</a>
            </div>
        </div>
    </div>
    </div>  
...
<div class="uk-container uk-container-center uk-margin-large-bottom">
    ...
    <div class="uk-grid" data-uk-grid-margin="">
        <div class="uk-width-medium-3-5">
            ...
            <div class="uk-panel">
                <div class="uk-panel-body">
                    {PRJ_SHORTTITLE|cot_uk_heading(1, "$this", "uk-h2")}
                    {PRJ_TEXT}
                </div>
            </div>
        ...
        <div class="uk-width-medium-4-10 uk-panel-body">
            ...
            <ul class="uk-list uk-list-line uk-text-large">
                ...
                <!-- ENDIF -->
                <li><span class="ti-linck-black tp-text-transform">{PHP.L.Date}:</span> {PRJ_DATE}</li>
            </ul>
            <hr>
