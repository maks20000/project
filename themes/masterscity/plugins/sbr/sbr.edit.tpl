    ...
    <div class="uk-container uk-container-center">
        ...
        <div class="tp-box">
            <div class="uk-panel-body">
                ...
                {SBREDIT_SUBTITLE|cot_uk_heading(1, "$this", "uk-h2 tp-text-transform uk-text-bold")}
                </div>
                <hr />
        ...
        <div id="sbrstageslist">
            <!-- BEGIN: STAGE_ROW -->
            <div class="stageblock tp-box uk-margin-large-top<!-- IF {STAGEEDIT_FORM_NUM} == {PHP.stagescount} --> laststage<!-- ENDIF -->">
                <div class="uk-panel-body">    
                    <div class="removestage uk-float-right<!-- IF {STAGEEDIT_FORM_NUM} == 1 --> uk-hidden<!-- ENDIF -->">
                        <a href="#" onclick="SbrRemoveStage(this); return false;"><i class="uk-icon-close uk-text-muted uk-text-large"></i></a>
                    </div>
                    <h3 class="uk-text-bold">{PHP.L.sbr_stage} № <span class="stagenum">{STAGEEDIT_FORM_NUM}</span></h3>
                    <div class="uk-form-row">
...
<script>
	...
	function StageFileAdd(obj)
	{
		...
		$(obj).parent().children('.fileslist').append('<li class="uk-margin-small-top">\n\
